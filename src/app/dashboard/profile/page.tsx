...
export default function ProfilePage() {
  ...
  const fetchApprovedSheets = async () => {
    ...
    const { data } = await supabase
      .from('salary_sheets')
      .select('id, month_year, sales_commission, basic_salary, ot_payment, monthly_bonus, special_allowance_01, special_allowance_02, wallet_adjustment, epf_employee, no_pay_deduction, salary_advance, stamp_duty, meeting_absence, advance_deduction, late_deductions, approved_at')
      .eq('user_id', user.id)
      .eq('status', 'approved')
