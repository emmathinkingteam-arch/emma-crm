...
//
// The send is still logged to whatsapp_broadcasts, which /admin/accounts/costing
// reads to attribute messaging cost. Per-recipient delivery tracking was removed
// along with the delivery viewer.
// ============================================================================
